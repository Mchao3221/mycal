...
| 布局 | 桌面端一屏工作台:左栏 240px 导航/概览,主体一日一卡**左右分栏**(记录区 + 540px AI 汇总栏),各自内部滚动 |
...
3. **主体一天一张卡,左右分栏**:左侧记录区自上而下 = 日期标题 → 当日流水(输入框回车即记,行内 ✎ 改 ✕ 删)→ 今日体重(同日覆盖,显示较 7 日均)→ 吃动打卡;右侧 540px 独立栏 = 「AI 每日汇总」(窄屏自动折到下方);
